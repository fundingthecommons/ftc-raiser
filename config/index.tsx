...
import {sepolia, mainnet, Chain, celo, arbitrum, base, optimism, polygon, gnosis, linea,} from 'wagmi/chains'
...
export const chains: Chain[] = [optimism, base, arbitrum, celo, polygon, gnosis, linea, mainnet] as const
