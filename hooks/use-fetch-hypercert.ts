...
const query = gql`query Hypercert($hypercert_id: String) {
...
export function useFetchHypercert(
	hypercertId = "11155111-0xa16DFb32Eb140a6f3F2AC68f41dAd8c7e83C4941-235135115542368478253191853735351834116096",
) {
